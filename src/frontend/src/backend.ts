...
export class Backend implements backendInterface {
    ...
    async getAllPlayers(): Promise<Array<PlayerState>> {
    ...
    async spawnPlayer(arg0: Position): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.spawnPlayer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async takeDamage(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.takeDamage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePosition(arg0: Position): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePosition(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
